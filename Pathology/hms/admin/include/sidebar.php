							...
							<li>
								<a href="javascript:void(0)">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Pathologists </span><i class="icon-arrow"></i>
										</div>
									</div>
								</a>
								<ul class="sub-menu">
									<li>
										<a href="doctor-specilization.php">
											<span class="title"> View And Add Test </span>
										</a>
									</li>
									<li>
										<a href="add-doctor.php">
											<span class="title"> Add Pathologist </span>
										</a>
									</li>
									<li>
										<a href="Manage-doctors.php">
											<span class="title"> View Pathologists  </span>
										</a>
									</li>
				...
				<li>
								<a href="javascript:void(0)">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Feedbacks and Queries </span><i class="icon-arrow"></i>
										</div>
									</div>
								</a>
								<ul class="sub-menu">
							...
							<li>
								<a href="javascript:void(0)">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Equipments </span><i class="icon-arrow"></i>
										</div>
									</div>
								</a>
								<ul class="sub-menu">
									...
									<li>
										<a href="addequipments.php">
											<span class="title"> Order Equipments </span>
										</a>
									</li>

									<li>
										<a href="seeorder.php">
											<span class="title"> View Order Details </span>
										</a>
									</li>
