...
if(isset($_GET['del']))
		  {
		          mysqli_query($con,"delete from pathologists where id = '".$_GET['id']."'");
...
<html lang="en">
	<head>
		<title>Admin | Pathologists</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | View Pathologists</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
						...
						<div class="container-fluid container-fullw bg-white">
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">View <span class="text-bold"> Pathologists</span></h5>
								...
								<?php echo htmlentities($_SESSION['msg']="");?></p>	
									<table class="table table-hover" id="sample-table-1">
										...
										<tbody>
<?php
$sql=mysqli_query($con,"select * from pathologists");
$cnt=1;
