...
$sql=mysqli_query($con,"insert into tests(specilization,Detail,TestFee) values('{$_POST['doctorspecilization']}','{$_POST['detail']}','{$_POST['docfees']}') ");
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<div class="container-fluid container-fullw bg-white">
							...
							<input type="text" name="doctorspecilization" class="form-control"  placeholder="Enter Test">
														</div>
														<div class="form-group">
															<label for="exampleInputEmail1">
																Test Price	
																</label>					
						<input type="text" name="docfees" class="form-control"  placeholder="Enter Test Price">
						</div>	
						<div class="form-group">
															<label for="exampleInputEmail1">
																Test Detail	
																</label>					
						<input type="text" name="detail" class="form-control"  placeholder="Enter Test Detail">
						</div>	
