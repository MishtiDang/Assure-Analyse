...
$sql=mysqli_query($con,"Update users set fullName='$fname',PhoneNumber='$patcontact',address='$address',city='$city',gender='$gender' where id='".$_SESSION['id']."'");
if($sql)
{
...
<div class="form-group">
	...
	<input type="text" name="id" class="form-control" value="<?php echo htmlentities($data['id']);?>" readonly >	
	</div>					
<div class="form-group">
															<label for="fname">
																 User Name
...
<div class="form-group">
 ...
 Patient Contact no(10 Digit Contact Number)
</label>
<input type="text" name="patcontact" class="form-control" value="<?php echo htmlentities($data['PhoneNumber']);?>">
</div>
<div class="form-group">
															<label for="address">
																 Address
