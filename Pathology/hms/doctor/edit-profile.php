...
$sql=mysqli_query($con,"Update pathologists set specilization='$docspecialization',Name='$docname',address='$docaddress',docFees='$docfees',contactno='$doccontactno' where id='".$_SESSION['id']."'");
if($sql)
{
echo "<script>alert('Pathologists Details Updated Successfully');</script>";
...
<html lang="en">
	<head>
		<title>Admin | Edit Pathologists Details</title>
